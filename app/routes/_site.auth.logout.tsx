      ...
      <div className="px-4 md:px-6 flex flex-col items-center space-y-4">
        <div className="w-full max-w-[700px] mx-auto text-center space-y-4">
          ...
          <p className="text-gray-500 md:text-xl dark:text-gray-400">
            Login action not implemented yet. You can customize this in{" "}
            <code className="text-orange-500">app/routes/_site.auth.logout.tsx</code>. If you want
            to quickly add authentication to your app, you can run the Remix-Breeze &nbsp;
